...
public class SwaggerConfig {
    ...
    private String base_package = "pe.yeilinux.dailyfood.controller";
    private String title = "MS DailyFood API";
    private String description = "Application to managment by week";
